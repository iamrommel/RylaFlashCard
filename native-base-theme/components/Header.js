...
export default (variables /* : * */ = variable) => {
  ...
  const headerTheme = {
      ...
      'NativeBase.Button': {
        ...
        '.transparent': {
          ...
          'NativeBase.Icon': {
            color: variables.toolbarBtnColor,
            fontSize:
              platform === PLATFORM.IOS && variables.platformStyle !== PLATFORM.MATERIAL ? variables.iconHeaderSize + 1 : variables.iconHeaderSize,
            marginTop: 0,
            marginRight: 2,
            marginLeft: 1,
            paddingTop: 1,
    ...
    height:
      variables.platform === PLATFORM.IOS && variables.platformStyle === PLATFORM.MATERIAL ? variables.toolbarHeight + 10 : variables.toolbarHeight,
    elevation: 3,
